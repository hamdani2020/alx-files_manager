...
describe('+ FilesController', () => {
  ...
  const mockFiles = [
    ...
    },
    {
      ...
      type: 'file',
      data: [
        '+ Chapter 47: The skies above a capital',
        '+ Chapter 48: 50 years',
        '+ Chapter 49: The wohdrld you wish for',
        '+ Chapter 50: Hojdnor',
        '+ Chapter 51: The shhogun of Wano - Kozuki Momonosuke',
  ...
  describe('+ POST: /files', () => {
    ...
    it('+ Fails if type is available but unrecognized', function (done) {
      ...
      request.post('/files')
        .set('X-Token', token)
        .send({ name: 'manga_titles.txt', type: 'nakamudra' })
        .expect(400)
        .end((requestErr, res) => {
          if (requestErr) {
            return done(requestErr);
